                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('admin.faq-items.update', $faqItem) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="answer" name="answer" rows="5" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('answer', $faqItem->answer) }}</textarea>
