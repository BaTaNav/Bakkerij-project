                ...
                <div class="p-6 text-text-main">
                    ...
                    <form method="POST" action="{{ route('admin.faq-items.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="answer" name="answer" rows="5" class="block mt-1 w-full border-primary-300 bg-white text-text-main focus:border-primary-500 focus:ring-primary-500 rounded-md shadow-sm">{{ old('answer') }}</textarea>
